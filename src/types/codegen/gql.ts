...
const documents = {
  ...
  "fragment ResourceBlock on ResourceBlockRecord {\n  id\n  title\n  resources {\n    title\n    description\n    link\n  }\n}":
    types.ResourceBlockFragmentDoc,
 ...
 */
export function graphql(
  source: "fragment ResourceBlock on ResourceBlockRecord {\n  id\n  title\n  resources {\n    title\n    description\n    link\n  }\n}"
): (typeof documents)["fragment ResourceBlock on ResourceBlockRecord {\n  id\n  title\n  resources {\n    title\n    description\n    link\n  }\n}"]
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
